...
let labelBackTransparentText = document.getElementById(
  "label-back-transparent-text"
);
...
botonMood.addEventListener("click", () => {
  if (mode === "dark") {
    ...
    colorPFooter.style.color = "var(--light-green)";
    document.querySelector("h1").style.color = "var(--dark-blue)";
    backHeader.style.borderBottom = "1px solid var(--orange)";
    bottonsText.style.borderBottom = "1px solid var(--orange)";
    boton.style.color = "var(--light-green)";
    boton.style.backgroundColor = "var(--purple)";
    botonImg.style.color = "var(--light-green)";
    botonImg.style.backgroundColor = "var(--purple)";
    botonText.style.color = "var(--light-green)";
    botonText.style.backgroundColor = "var(--purple)";
    buttonDownload.style.backgroundColor = "var(--purple)";
    buttonDownload.style.color = "var(--light-green)";
    icon.className = "fa-solid fa-moon";
    buttonsImg.style.background = "var(--pink)";
    buttonsImg.style.borderBottom = "1px solid var(--orange)";
    listImage.style.background = "var(--pink)";
    fondos.style.background = "var(--pink)";
    filtros.style.background = "var(--pink)";
    imageButton.style.background = "var(--purple)";
    fondo.style.background = "var(--purple)";
    filtro.style.background = "var(--purple)";
    ...
    listImage.style.borderBottom = "1px solid var(--orange)";
    textList.style.borderBottom = "1px solid var(--orange)";
    bottonsText.style.backgroundColor = "var(--pink)";
    buttonText.style.backgroundColor = "var(--purple)";
    buttonColor.style.backgroundColor = "var(--purple)";
    buttonSpace.style.backgroundColor = "var(--purple)";
    textList.style.backgroundColor = "var(--pink)";
    ...
    colorTextList.style.backgroundColor = "var(--pink)";
    spaceTextList.style.backgroundColor = "var(--pink)";
    colorTextList.style.borderBottom = "1px solid var(--orange)";
    spaceTextList.style.borderBottom = "1px solid var(--orange)";
    fondos.style.borderBottom = "1px solid var(--orange)";
